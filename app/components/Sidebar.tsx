        ...
        <ul className='sidebar-ul mb-5 fs-4 '>
          ...
          <li className='py-3'>
            <span>
              ...
              <div className='d-none d-lg-inline-flex'>
                <a href='https://twitter.com/explore'>Exproler</a>
              </div>
            </span>
          </li>
          <li className='py-3'>
            <span>
              ...
              <div className='d-none d-lg-inline-flex'>
                <a href='https://twitter.com/notifications'>Notifications</a>
              </div>
            </span>
          </li>{' '}
          <li className='py-3'>
            <span>
              ...
              <div className='d-none d-lg-inline-flex'>
                <a href='https://twitter.com/messages'>Messages</a>
              </div>
            </span>
          </li>{' '}
          <li className='py-3 d-none d-md-block'>
            <span>
              ...
              <div className='d-none d-lg-inline-flex'>
                <a href='https://twitter.com/lists'>Lists</a>
              </div>
            </span>
          </li>{' '}
          <li className='py-3'>
            <span>
              ...
              <div className='d-none d-lg-inline-flex'>
                <a href='https://twitter.com/i/bookmarks'>Bookmarks</a>
              </div>
            </span>
          </li>{' '}
          <li className='py-3'>
            <span>
              ...
              <div className='d-none d-lg-inline-flex'>
                <a href='https://twitter.com/i/verified-choose'>Verified</a>
              </div>
            </span>
          </li>{' '}
          <li className='py-3'>
